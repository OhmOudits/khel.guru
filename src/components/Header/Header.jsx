    ...
    <>
      ...
      <div className="flex items-strech gap-3">
        ...
        <div className="p-1 rounded-xl bg-secondry flex gap-2 text-white">
          <div className="cursor-pointer login p-2 px-5 bg-ter flex items-center justify-center hover:bg-terHover rounded-xl font-semibold ">
            Login
          </div>
          <div className="cursor-pointer register p-2 px-6 rounded-xl bg-button">
            Register
          </div>
        </div>
      </div>
