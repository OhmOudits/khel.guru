        ...
        <div className="my-4 px-3 flex flex-col">
          ...
          {betMode === "manual" && (
            <>
              ...
              {/* Bet button */}
              <div className="order-2 md:order-20 transition-all duration-300 ease-in-out transform active:scale-90 text-black bg-button-primary flex items-center justify-center w-full mx-auto py-1.5 mt-3 max-lg:mt-4 rounded cursor-pointer text-lg font-semibold">
                Bet
              </div>
            </>
          )}
