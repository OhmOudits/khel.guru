...
const CricketBet = ({ teams }) => {
  const [bet, setBet] = useState("0.000000");
  const [select, setSelect] = useState(teams && teams[0]);
  ...
  return (
    <>
      <div className="grid grid-cols-8 max-md:grid-cols-1 gap-2 place-items-center bg-primary-1">
        <div className="flex flex-col gap-2 max-md:gap-0 px-3.5 py-5 max-md:pb-2 col-span-3 w-full">
        ...
        <div className="flex flex-col gap-2 px-3.5 py-5 max-md:py-0 col-span-3 w-full">
          <h1 className="w-full text-center text-sm text-gray-400 max-md:hidden">
            Winner
          </h1>
        ...
        <div className="flex flex-col gap-2 px-3.5 py-5 max-md:pt-2 col-span-2 w-full">
          <div>
            <input
              id="bet"
              value={bet}
