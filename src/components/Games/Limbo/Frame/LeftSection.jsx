          ...
          {betMode === "manual" && (
            <>
              <BetAmount
                ...
                setStart
              />
              <div className="w-full -mb-5  order-10 md:order-2">
                <h1 className="font-semibold mt-1 capitalize   text-label">
                  Profit on win
                </h1>
                <input
                  type="text"
                  disable
                  value={EstProfit}
                  className="w-full mt-2  rounded h-[44px] bg-secondry outline-none text-white px-2 pr-6 py-2 border border-input hover:border-primary-4"
                />
              </div>
              {/* Bet button */}
              <div
                className={`order-2 max-md:mb-2 md:order-20 transition-all  duration-300 ease-in-out transform active:scale-90 flex items-center justify-center w-full mx-auto py-1.5 mt-10 max-lg:mt-4 rounded text-lg font-semibold ${
                  start
            ...
            <>
              ...
              <div className="w-full mb-1 order-10 md:order-2">
                ...
                <input
                  ...
                  className="w-full mt-2  rounded h-[36px] bg-secondry outline-none text-white px-2 pr-6 py-2 border border-input hover:border-primary-4"
                />
              </div>
              ...
              <div className="order-10 md:order-2 py-3 w-full">
                ...
                <div className="flex mt-2 bg-inactive rounded p-0.5 pb-[0.20rem]">
                  ...
                  <div
                    ...
                    className={`text-sm cursor-pointer font-semibold w-[220px] mr-1 ${
