...
const AnimationComponent = () => {
  ...
  // Initialize refs array for each h1 element
  const initializeH1Refs = (index) => (el) => {
  ...
  useEffect(() => {
    ...
    scene1
      ...
      .to(h1Refs.current[2], { y: 1.7 * speed, x: 1.2 * speed }, 0.03)
      .to(h1Refs.current[3], { y: 3 * speed, x: 1 * speed }, 0.03)
      .to(h1Refs.current[4], { y: 2 * speed, x: 1 * speed }, 0.03);
    ...
    gsap.fromTo(
      ...
      { opacity: 1 },
      {
        ...
        scrollTrigger: {
          ...
          scrub: 4,
          onEnter: () => gsap.to(birdRef.current, { scaleX: 1, rotation: 0 }),
          onLeave: () =>
            gsap.to(birdRef.current, { scaleX: -1, rotation: -15 }),
        },
      }
    );
    ...
    clouds
      .to(cloud1Ref.current, { x: 500 }, 0)
      .to(cloud2Ref.current, { x: 1000 }, 0)
      .to(cloud3Ref.current, { x: -1000 }, 0)
      .to(cloud4Ref.current, { x: -700, y: 25 }, 0);
    ...
    sun.to(sunRef.current, { attr: { cy: "330" } }, 0);
  ...
  return (
    <>
      ...
      >
        ...
        <g ref={initializeH1Refs(2)} style={{ visibility: "hidden" }}>
          <rect
            id="bg2"
            y="-59.8"
            width="750"
      ...
      <div id="scrollElement" className="h-full w-full"></div>
    </>
  );
};
